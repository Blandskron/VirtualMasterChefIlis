            ...
            <form onSubmit={createRecipe}>
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  onChange={(e) => setNewRecipe({ ...newRecipe, ingredientes: e.target.value.split(',') })}
                  required
                />
              </div>
              <div className="form-group mb-3">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  onChange={(e) => setNewRecipe({ ...newRecipe, tiempoPreparacion: e.target.value })}
                  required
                />
              </div>
              <div className="form-group mb-3">
              ...
              <div className="form-group mb-3">
                ...
                <input
                  ...
                  onChange={(e) => setNewRecipe({ ...newRecipe, participante: e.target.value })}
                  required
                />
              </div>
        ...
        <div className="card recipe-form-card mb-4">
          <div className="card-body">
            ...
            <form onSubmit={updateRecipe}>
              ...
              <button type="submit" className="btn btn-success">Actualizar Receta</button>
              <button
                type="button"
